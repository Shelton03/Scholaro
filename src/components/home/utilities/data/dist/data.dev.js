...
var api_simulation_data = {
  "undergraduate": [{
    ...
    requirements: ["Fill Application Form", "Submit one page application letter", "Submit Headmaster's Motivational Letter", "Submit two recent passport sized photos", "Submit Certified Copies of Birth Certificate and National ID", "Submit Exam Certificates"],
    ...
    requirements: ["Fill application form", "Submit university admission letter", "Submit Certified Copies of Academic Certficates, Birth Certificate and National ID", "Submit Recommendation Letter", "Submit 500 word motivational letter"],
    ...
    requirements: ["Fill Application Form", "Submit admissin letter", "Submit Recommendation Letter", "Submit Certified Copies of Birth Certificate and National ID", "Submit Exam Certificates"],
    ...
    requirements: ["Fill Application Form", "Submit one page application letter", "Submit Headmaster's Motivational Letter", "Submit a recent passport photo", "Submit Certified Copies of Birth Certificate and National ID", "Submit Exam Certificates"],
  ...
  "postgraduate": [{
    ...
    requirements: ["Submit Official Transcripts", "Submit resume", "Submit motivational letter", "Submit two letters of recommendation", "Fill application form", "Submit proof of residence", "Submit passport scan"],
...
exports.api_simulation_data = api_simulation_data;